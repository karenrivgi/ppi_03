...
class StarMap:
    ...
    def __init__(self, master: tk.Tk, user = None) -> None:
        ...
        self.dateText = tk.Label(self.canvasDate, text= "Date (aaaa-mm-dd)", font = ("BeVietnamPro-Bold", int(12)), width = 18, fg = "#ffffff", bg= "black")
        self.dateText.grid(row = 0, column = 0)

        self.hourText = tk.Label(self.canvasDate, text= "Hour (hh:mm)", font = ("BeVietnamPro-Bold", int(12)), width = 18, fg = "#ffffff", bg= "black")
