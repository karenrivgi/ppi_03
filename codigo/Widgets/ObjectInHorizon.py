...
class ObjectInHorizon:
    ...
    def __init__(self, master: tk.Tk, user=None):
        ...
        self.horizonCanvas.place(x=0, y=0, relwidth=1, relheight=1, anchor='nw')
    ...
    def create_widgets(self):
        ...
        self.canvasPosition = tk.Frame(self.horizonFrame, highlightthickness=0, background= "black")
        ...
        self.canvasDate = tk.Frame(self.horizonFrame, highlightthickness=0, background= "black")
        ...
        astrosOptions=['Sun','Mercury','Venus', 'Moon','Mars','Jupiter','Saturn','Uranus','Neptune','Pluto']
        self.astroName.set('Sun')

        self.dicAstros={'Sun': 'sun','Mercury':'mercury','Venus':'venus', 'Moon': 'moon',
        ...
        self.astrosList = tk.OptionMenu(self.canvasDate,self.astroName,*astrosOptions)
    ...
    def get_times_horizon(self):
        ...
        # Obtener la ubicación, fecha y objeto celeste seleccionado por el usuario
        ubicacion, fecha, astro = self.save_data()

        # Utilizar el módulo planetHorizon para obtener los tiempos en que el objeto celeste se eleva y se pone por encima del horizonte
        times = planetHorizon.when_above_horizon(ubicacion, fecha, astro)

        # Crear una etiqueta para cada tiempo y mostrarlo en la interfaz gráfica de usuario
